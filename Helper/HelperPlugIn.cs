...
namespace Helper
{
	...
	[HelpFileBuilderPlugInExport("Helper", Version = AssemblyInfo.ProductVersion,
	  Copyright = AssemblyInfo.Copyright, Description = "Helper plug-in")]
	public sealed class HelperPlugIn : IPlugIn
	{
		...
		public void Execute(ExecutionContext context)
		{
			...
			builder.ReportProgress("In HelperPlugIn Execute() method");
		}
		#endregion
